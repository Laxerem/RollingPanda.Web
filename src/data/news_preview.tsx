...
export const newsPreview: Array<INewsContent> = [
    {
        mainDate: new Date(2025, 11, 3),
        otherDate: new Date(2025, 11, 25),
    ...
    {
        mainDate: new Date(2025, 11, 14),
        otherDate: new Date(2025, 11, 15),
    ...
    {
        mainDate: new Date(2025, 11, 22),
        otherDate: new Date(2025, 11, 3),
